...
class Draw extends Component {
  ...
  async offerDraw() {
    ...
    const offer = await axios.put(`https://chess-club.herokuapp.com/games/draw/offer`, { id, userId: user.id });
    if (offer.status === 200) {
  ...
  async acceptDraw() {
    ...
    const response = await axios.put(`https://chess-club.herokuapp.com/games/draw/accept`, { 
      id, 
      completed: true,
      winner: null,
    });
  ...
  async declineDraw() {
    ...
    const response = await axios.put(`https://chess-club.herokuapp.com/games/draw/offer`, { id, userId: user.id });
