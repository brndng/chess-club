...
export const updatePosition = (
  ...
  if (
    (piece === "p" && destin.row === 7) ||
    (piece === "P" && destin.row === 0)
  ) {
    return {
      type: "PAWN_PROMOTED",
      payload: [
    ...
    const captured = piece === piece.toUpperCase() ? "p" : "P";
    return {
...
export const loadSquareDetails = (
  coords,
  piece,
  candidateSquares,
  userId,
  ...
  const isAlly =
    piece !== null && (userId === white) === (piece === piece.toUpperCase());
  return {
    type: "SQUARE_UPDATED",
