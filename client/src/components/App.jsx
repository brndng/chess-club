    ...
    return (
      <div className="route-container">
        ...
        <Route
          exact
          path="/"
          render={props => <LandingWithAuth {...props} />}
        />
        <Route
          path="/gamelist"
          render={props => <GameListWithAuth {...props} />}
        />
        <Route path="/game/:id" render={props => <GameWithAuth {...props} />} />
        <Route
          path="/challenge"
          render={props => <ChallengeWithAuth {...props} />}
        />
        <Route
          path="/archive"
          render={props => <ArchiveWithAuth {...props} />}
        />
        <Route
          path="/completed/:id"
          render={props => <CompletedGameWithAuth {...props} />}
        />
